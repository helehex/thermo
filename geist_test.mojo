...
fn main() raises:
    Game(sdl.SDL(video=True, timer=True, events=True, gfx=True, img=True)).register_update[test_update]().add_sprite(_dir_of_current_file() / "assets/sprites/crate.png").create_camera().run()
